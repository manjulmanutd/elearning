...
<!--<li class=""><a href="<?php echo base_url();?>page_manager" <?php if($this->uri->segment(2) == 'page_manager'){echo 'class="active"';}?>><i class="icon-book"></i>Page Manager</a></li> -->
    <li class=""><a href="<?php echo base_url();?>schedule/list_schedule" <?php if($this->uri->segment(1) == 'schedule'){echo 'class="active"';}?>><i class="icon-file"></i>Schedule Manager</a></li>
    <li class=""><a href="<?php echo base_url();?>admin/liveChat" <?php if($this->uri->segment(1) == 'livechat'){echo 'class="active"';}?>><i class="icon-user"></i>Live Chat</a></li>
    ...
    <li class=""><a href="<?php echo base_url();?>" <?php if($this->uri->segment(2) == 'site_configuration'){echo 'class="active"';}?>><i class="icon-cog"></i>Login Configuration</a></li>
  </ul>
</div>
