...
<div class="add_new"><form action="<?php echo base_url(); ?>appointment/add_holiday" method="post"><input type="submit" value="Add new" name="add" class="btn btn-inverse"></form></div>
