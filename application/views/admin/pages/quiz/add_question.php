...
<h2>Add question for <?php echo $detail;?></h2><h3>(Question Posted successfully)</h3>
<div class="seperator"></div>
<form action="<?php echo base_url();?>quiz/add_question/<?php echo $this->uri->segment(3);?>" method="post" id="qtn">
<h3>Question:</h3>
...
<div class="ans"><input type="radio" name="correct" value="1"> <input type="text" name="answer1" class="required"></div>
...
<div class="ans2"><input type="checkbox" name="correct1" value="1"> <input type="text" name="answer1" class="required"></div>
...
<h3>Marks : </h3>
<input type="text" name="mark" class="required">
<div class="seperator"></div>
<input type="submit" value="Done" class="btn btn-primary"> <a href="<?php echo base_url();?>quiz" class="btn btn-success">Go to Test Manager</a>
</form>