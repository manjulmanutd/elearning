...
if($q != NULL)
{
    ...
    ?>
<h3>Question:</h3>
<form action="<?php echo base_url();?>quiz/edit_submit/<?php echo $this->uri->segment(3);?>" method="post" id="qtnr">
...
<textarea name="q" class="required"><?php echo $qu['question'];?></textarea>    
	...
	?>
    <h3>Marks : </h3>
        <input type="text" name="mark" class="required" value="<?php echo $qu['marks'];?>">
    <div class="seperator"></div>
