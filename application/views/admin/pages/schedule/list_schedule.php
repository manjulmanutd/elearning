...
<a href="<?php echo base_url()?>schedule/configure_working_days" class="btn btn-danger">Configure Week Days</a>
<a href="<?php echo base_url()?>schedule/configure_holidays" class="btn btn-info">Configure Holidays</a>
<a href="<?php echo base_url(); ?>timeslot/list_schedule_timeslots" class="btn btn-inverse">Manage Time Slots</a>
<a href="<?php echo base_url()?>schedule/view_all_schedules" class="btn btn-primary">View All Schedules</a>
<!--a href="<?php echo base_url()?>schedule/list_schedule" class="btn btn-success">Manage Schedules</a-->
