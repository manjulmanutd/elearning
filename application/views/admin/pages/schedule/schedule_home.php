	...
	?>
		<tr>
			...
			<td class='c_right'><?php echo $schedule->training_date;?></td>
                       	<td class='c_right'><?php if($this->schedule_model->getTrainingTimeById($schedule->timeslot_id))echo $this->schedule_model->getTrainingTimeById($schedule->timeslot_id)->time;?></td>
                        <td class='c_right'><?php if($this->schedule_model->getSessionNameById($schedule->session_id))echo $this->schedule_model->getSessionNameById($schedule->session_id)->session_name;?></td>
