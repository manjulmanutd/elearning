...
?>
    ...
    <?php } ?>
        ...
        <?php $courseId = $this->uri->segment('3');?>
  <ul>
    ...
    <!--li><a href="<?php echo base_url();?>trainee/course_dashboard"><i class="icon-eye-open" ></i><span class="menutext">Course Dashboard</span></a></li-->
   <!-- <li>
   ...
   <!--li><a href="<?php echo base_url();?>trainee/trainee_dashboard"><i class="icon-leaf" ></i><span class="menutext">Training Dashboard</span></a></li-->
     <!--li><a href="<?php echo base_url();?>enroll/getPaymentHistory"><i class="icon-eye-open" ></i><span class="menutext">My Payment History</span></a></li-->
       <li><a href="<?php echo base_url();?>trainee/view_archive_documents/<?php echo $courseId?>"><i class="icon-cog" ></i><span class="menutext">Resources</span></a></li>
         <li><a href="<?php echo base_url();?>trainee/view_archive_assignments/<?php echo $courseId?>"><i class="icon-question-sign" ></i><span class="menutext">Assignments</span></a></li>
         <li><a href="<?php echo base_url();?>trainee/feedback_archive/<?php echo $courseId?>"><i class="icon-list-alt" ></i><span class="menutext">Feedback</span></a></li>
