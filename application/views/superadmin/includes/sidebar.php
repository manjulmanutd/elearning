...
?>
  ...
  <ul>
    ...
    <li class=""><a href="<?php echo base_url();?>superadmin/site_configuration" <?php if($this->uri->segment(1) == 'site_configuration'){echo 'class="active"';}?>><i class="icon-cog"></i>Super Admin Configuration</a></li>
