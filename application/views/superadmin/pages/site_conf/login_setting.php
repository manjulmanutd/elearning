...
<form action="<?php echo base_url(); ?>superadmin/edit_login" method="post" id="register">
    ...
    if ($admin) {
        ...
        ?>
        <h3>Username :</h3>
        <input type="text" name="ad_un" value="<?php echo $a['admin_username'] ?>" class="required" required>
        ...
        <h3>First Email :</h3>
        <input type="text" name="first_email" id="first_email" value="<?php echo $a['admin_email1'] ?>" class="required" required>
