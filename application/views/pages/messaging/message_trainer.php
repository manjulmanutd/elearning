...
<h2>Message Trainer (<?php echo $this->trainee_model->getCourseNameById($courseId)->course_name;?>)</h2>
<div class="seperator"></div>
<form action="<?php echo base_url(); ?>trainee/send_message_trainer/<?php echo $courseId;?>" method="post" enctype="multipart/form-data" id="trainer_form">
