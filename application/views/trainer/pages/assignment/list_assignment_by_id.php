        ...
        if ($documents) {
            ...
            foreach ($documents as $document):
                ...
                <tr>
                    ...
                    <td class='c_right'><?php echo $this->assignment_model->getSessionNameById($document->schedule_id)->session_name.
                                " ".$this->assignment_model->getLessonNameById($document->lesson_id)->lesson_name; ?></td>
                    <td class='action'>
