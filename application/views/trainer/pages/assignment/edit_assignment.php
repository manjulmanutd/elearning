...
?>
<form action="<?php echo base_url();?>assignment/update_assignment/<?php echo $document->doc_id;?>" method="post" enctype="multipart/form-data" id="upload">
...
<select name="schedule_id">
   ...
   <option <?php echo $selected;?> value="<?php echo $schedule->training_id; ?>"><?php echo $this->assignment_model->getCourseNameById($schedule->course_id)->course_name." ".$this->assignment_model->getLessonNameById($schedule->lesson_id)->lesson_name." ( ".date('d M Y',strtotime($schedule->training_date)).")";; ?></option>
    <?php endforeach; ?>
</select>
