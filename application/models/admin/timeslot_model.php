...
class Timeslot_model extends CI_Model {
    ...
    function removeAppointmentTimeslot(){
     ...
     function listAllScheduleTimeslots() {
    ...
    function addScheduleTimeslot() {
        ...
        return $this->db->insert('tbl_timeslot_schedule', $data);
    }
    
    function removeScheduleTimeslot(){
         $id = $this->uri->segment(3);
        $q = mysql_query("DELETE FROM tbl_timeslot_schedule WHERE id = '$id'");
        return $q;
    }
