...
class Assignment extends CI_Controller {
    ...
    * */
    ...
    function provide_feedback(){
        $data['feedbackByLesson'] = $this->assignment_model->getFeedbackById();
        $data['dashboard'] = 'trainer/pages/assignment/provide_feedback_training';
        $this->load->view('trainer/trainer_dashboard', $data);
        
    }
    
    function provideFeedback($trainingId, $userId){
        
        $this->assignment_model->provideFeedback($userId, $trainingId);
        $data['allTrainees'] = $this->assignment_model->getTraineesBySchedule($trainingId);
